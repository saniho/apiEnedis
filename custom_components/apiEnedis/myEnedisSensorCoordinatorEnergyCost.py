...
class myEnedisSensorCoordinatorEnergyCost(CoordinatorEntity, RestoreEntity):
    """."""
    ...
    def unique_id(self):
        ...
        if self._typeSensor == _production:
            name = "myEnedis.energy.cost.%s.production" %(self._myDataSensorEnedis.get_PDL_ID())
        else:
            name = "myEnedis.energy.cost.%s" %(self._myDataSensorEnedis.get_PDL_ID())
        return name
    ...
    def _update_state(self):
        ...
        status_counts, state = self._myDataSensorEnedis.getStatusEnergyCost( self._typeSensor )
        self._state = state
