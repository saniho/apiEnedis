...
class myEnedisSensorCoordinatorEcoWatt(BaseEnedisCoordinatorEntity):
    def __init__(
        self,
        sensor_type,
    ...
    @property
    def unique_id(self):
        return f"myEnedis.{self._myDataSensorEnedis.get_PDL_ID()}.EcoWatt"
